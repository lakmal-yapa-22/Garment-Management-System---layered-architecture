...
INSERT INTO Product (product_id, qty, price, product_type, color, size) VALUES
                                                                            ('P001', 1750, 1500.00, 'frock', 'white', 'S'),
                                                                            ('P002', 1800, 1200.00, 't-shirt', 'black', 'M'),
                                                                            ('P003', 1850, 2000.00, 'pant', 'blue', 'L'),
                                                                            ('P004', 1950, 2500.00, 'trouser', 'red', 'XL'),
                                                                            ('P005', 1600, 1300.00, 'long_sleeve_shirt', 'green', 'XXL'),
                                                                            ('P006', 1750, 1100.00, 'long_sleeve_t_shirt', 'yellow', 'S'),
                                                                            ('P007', 1800, 1400.00, 'frock', 'blue', 'M');
