...
import lk.ijse.deb.bo.custom.impl.BuyerSignUpBOImpl;
...
public class BuyerSignUpControllerr {
    BuyerSignUpBOImpl buyerSignUpBO=new BuyerSignUpBOImpl();
    @FXML
    ...
    private boolean saveUser(String email, String username, String password, String type) throws SQLException, ClassNotFoundException {
        return buyerSignUpBO.buyersinUp(email, username, password, type);
    }
    @FXML
    void txtLoginOnMouseClickedAction(MouseEvent event) throws IOException {
        AnchorPane rootNode = FXMLLoader.load(getClass().getResource("/view/Buyer/buyerLogin.fxml"));
